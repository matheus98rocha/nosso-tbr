-- Stats RPCs must aggregate all completed books for the selected reader,
-- including solo/private titles (RN56 RLS would otherwise hide them for other viewers).
